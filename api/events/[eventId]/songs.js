// Supabase Song Addition API with Dynamic Routing
// Route: /api/events/[eventId]/songs
const { 
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // Phase 2: リクエスト検証（動的ルーティングでeventIdを取得）
    ...
    if (!eventId || !title || !artist || !deviceId) {
      ...
      return res.status(400).json({ 
        ...
        required: ['eventId (from URL)', 'title', 'artist', 'deviceId']
      });
    }
